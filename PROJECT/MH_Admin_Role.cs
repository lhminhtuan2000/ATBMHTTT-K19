...
namespace PROJECT
{
    public partial class MH_Admin_Role : Form
    {
        ...
        public void dgv4_loaddata(string user)
        {
            List<string> varList = new List<string> { "user" };
            List<string> inputList = new List<string> { user };
            DataTable dt = new DataTable();

            dt = Program.loadDT("sp_show_role_user", username, password, varList, inputList);
            dgv4.DataSource = dt;
        ...
        private void dgv4_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                int rowIndex = dgv4.CurrentCell.RowIndex;
                string role_name = dgv4.Rows[rowIndex].Cells[0].Value.ToString();
                tb1.Text = role_name;
            }
            catch (Exception ex)
            {
        ...
        private void bt_grant_table_Click(object sender, EventArgs e)
        {
            ...
            if (privilege == "SELECT")
            {
                ...
                List<string> inputList = new List<string> { role, schema_name, table, column, wgo };
            ...
            else if (privilege == "INSERT") // NO COLUMN
            {
                ...
                List<string> inputList = new List<string> { role, schema_name, table, wgo };
        ...
        private void bt_revoke_table_Click(object sender, EventArgs e)
        {
            ...
            if (privilege == "SELECT")
            {
                ...
                List<string> inputList = new List<string> { role, table };
            ...
            else if (privilege == "INSERT")
            {
                ...
                List<string> inputList = new List<string> { role, schema_name, table };
        ...
        private void bt_grant_obj_Click(object sender, EventArgs e)
        {
            ...
            List<string> inputList = new List<string> { role, privilege, schema_name, obj, wgo };
        ...
        private void bt_revoke_obj_Click(object sender, EventArgs e)
        {
            ...
            List<string> inputList = new List<string> { role, privilege, schema_name, obj };
        ...
        private void bt_grant_sys_Click(object sender, EventArgs e)
        {
            ...
            List<string> inputList = new List<string> { role, privilege, wgo };
        ...
        private void bt_revoke_sys_Click(object sender, EventArgs e)
        {
            ...
            List<string> inputList = new List<string> { role, privilege };
